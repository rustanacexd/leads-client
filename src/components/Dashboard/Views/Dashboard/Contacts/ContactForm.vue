    ...
    <form class="form-horizontal">
      <div class="card-header">
        <h4 class="card-title">
          ...
          Contact Form <span v-if="$route.params.id"> (ID {{$route.params.id}})</span>
        </h4>
      </div>
        ...
        <div class="row text-center" style="max-width: 500px; margin: 0 auto">
          <div class="card-footer col-sm-6">
            <button type="submit" @click.prevent="validate('updateResource')"
                    class="btn btn-fill btn-info btn-wd">Update Contact
            </button>
          </div>
          <div class="card-footer col-sm-6">
            <button type="button" @click="deleteResource"
                    class="btn btn-fill btn-danger btn-wd">Delete Contact
            </button>
          </div>
        </div>
      </template>
